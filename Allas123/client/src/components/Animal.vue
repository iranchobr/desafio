    ...
    <form id="form" @submit="store(animal)">
      <div class="form-row" >
        <div class="form-group col-md-6">
          ...
          <input type="Nome" class="form-control" id="inputNome4" placeholder="Nome" v-model="animal.no_animal" >
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="input4" placeholder="ex: Nelore .." v-model="animal.no_raca" >
        </div>
        <div class="form-group col-md-6">
          <label for="input4">peso</label>
          <input type="number" class="form-control" id="number" min="0" placeholder="ex: 20" v-model="animal.vr_peso" >
        </div>
        <div class="form-group col-md-6">
          <label for="input4">Data de Nascimento</label>
          <input type="date" class="form-control"  placeholder="" v-model="animal.dt_nascimento" >
        </div>
        <!-- disabilitar -->
         <div class="form-group col-md-6">
          <label for="input4"> ID Pessoa</label>
          <input type="text" class="form-control"  placeholder="selecione na tabela abaixo"  readonly="readonly" v-model="animal.id_pessoa" >
        </div>
      </div>
      ...
      <button v-if="!animal.id" type="submit" class="btn btn-primary">Cadastrar</button>
    ...
    <table class="table table-dark">
      ...
      <tbody class="thead-dark">
        <tr v-for="user in users" :key="user.id">
          ...
          <td>
            <button @click="animal.id_pessoa = user.id" class="btn btn-warning" >selecionar</button>
          </td>
        </tr>
      </tbody>
    </table>
