<template>
  ...
  <div class="form-row" >
    <div class="form-group col-md-6">
      ...
      <input type="Nome" class="form-control" id="inputNome4" placeholder="Nome" v-model="lote.no_lote" >
    </div>
    <div class="form-group col-md-6">
      <label for="input4">descrição</label>
      <input type="text" class="form-control" id="input4" placeholder="Descrição" v-model="lote.ds_lote" >
    </div>
  </div>
